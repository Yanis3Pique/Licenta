...
namespace Licenta_v1.Data.Migrations
{
    ...
    [Migration("20250330114420_BD_7.10")]
    partial class BD_710
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Licenta_v1.Models.OptimizationLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegionId", "IsRunning")
                        .IsUnique();

                    b.ToTable("OptimizationLocks");
                });
            ...
            modelBuilder.Entity("Licenta_v1.Models.Order", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("InaccessibleHeavyVehicleIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.PrimitiveCollection<string>("ManuallyRestrictedVehicleIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
