			...
			using (var context = new ApplicationDbContext(serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
			{
				...
				context.Users.AddRange(
					new ApplicationUser
					{
						...
						FirstName = "Gerard",
						LastName = "Pique",
						HomeAddress = "Str. 1 Decembrie 1918, nr. 1, Craiova",
					...
					new ApplicationUser
					{
						...
						FirstName = "Lionel",
						LastName = "Messi",
						HomeAddress = "Str. 1 Decembrie 1918, nr. 1, Pitești",
					...
					new ApplicationUser
					{
						...
						FirstName = "Sergio",
						LastName = "Busquets",
						HomeAddress = "Str. 1 Decembrie 1918, nr. 2, Pitești",
					...
					new ApplicationUser
					{
						...
						FirstName = "Andres",
						LastName = "Iniesta",
						HomeAddress = "Str. 1 Decembrie 1918, nr. 1, Slatina",
